const SobreMi = () => {
  return (
    <section className="py-24 px-6 max-w-7xl mx-auto w-full transition-colors duration-300" id="sobre-mi">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-crema-azulado dark:bg-neutral-900/40 p-8 md:p-12 lg:p-16 rounded-sm border border-neutral-200 dark:border-white/5 transition-colors shadow-sm"> 
        {/* Imagen */}
        <div className="relative group overflow-hidden rounded-sm aspect-[4/3] lg:aspect-square shadow-2xl bg-neutral-200 dark:bg-neutral-900">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 text-sm md:text-base font-textos mb-6 leading-relaxed transition-colors">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 text-sm md:text-base font-textos mb-10 leading-relaxed transition-colors">
          ...
          <div>
            <a href="#contacto" className="inline-flex items-center gap-4 text-xs font-bold uppercase tracking-widest text-neutral-900 dark:text-white border border-neutral-400 dark:border-white/20 px-8 py-4 hover:border-azul-logo hover:bg-azul-logo hover:text-white transition-all duration-300 group">
              Conocer Más
