...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-crema-suave dark:bg-neutral-950 flex flex-col justify-center items-center px-6 relative z-10 transition-colors duration-300">
      ...
      {/* Contenedor unificado con fondo #78A4CB y borde superior azul */}
      <div className="w-full max-w-md bg-[#78A4CB]/15 dark:bg-neutral-900 p-8 md:p-12 shadow-xl border-t-4 border-t-azul-logo relative overflow-hidden transition-colors">
        ...
        <form onSubmit={manejarSubmit} className="flex flex-col gap-8 relative z-10">
          <div className="flex flex-col gap-3">
            <label className="text-xs font-bold uppercase tracking-[0.15em] text-neutral-700 dark:text-neutral-300 ml-1">Email</label>
            <input 
              type="email" 
              value={email}
          ...
          <div className="flex flex-col gap-3">
            <label className="text-xs font-bold uppercase tracking-[0.15em] text-neutral-700 dark:text-neutral-300 ml-1">Contraseña</label>
            <input 
              type="password" 
              value={password}
