...
const Servicios = () => {
  ...
  return (
    <section
      ...
      className="pt-4 pb-16 px-4 max-w-7xl mx-auto w-full overflow-hidden transition-colors duration-300 min-h-[650px]"
    >
      ...
      {cargando ? (
        <div className="h-[500px] flex items-center justify-center">
          <p className="text-neutral-500 text-xs font-bold uppercase tracking-widest animate-pulse">
            Cargando servicios...
          </p>
        </div>
