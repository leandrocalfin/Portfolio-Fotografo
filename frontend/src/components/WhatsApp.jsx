...
const WhatsApp = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 group grid place-items-center w-14 h-14"
      aria-label="Contactar por WhatsApp"
    >
      {/* Ondas expansivas */}
      <span
        aria-hidden="true"
        className="absolute inset-0 rounded-full bg-[#25D366] animate-onda-whatsapp"
      />
      <span
        aria-hidden="true"
        className="absolute inset-0 rounded-full bg-[#25D366] animate-onda-whatsapp [animation-delay:0.9s]"
      />
      {/* Botón verde original WhatsApp */}
      <span className="relative grid place-items-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-[0_0_15px_rgba(37,211,102,0.45)] group-hover:scale-110 group-hover:shadow-[0_0_25px_rgba(37,211,102,0.7)] transition-all duration-300">
        <svg
