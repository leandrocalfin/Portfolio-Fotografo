const Contacto = () => {
  return (
    <section className="pt-4 pb-16 px-6 max-w-7xl mx-auto w-full transition-colors duration-300" id="contacto">
      ...
      {/* Contenedor adaptado con fondo #78A4CB y borde superior azul de acento */}
      <div className="max-w-3xl mx-auto bg-[#78A4CB]/15 dark:bg-neutral-900 p-8 md:p-12 shadow-xl border-t-4 border-t-azul-logo border-x border-b border-neutral-300/40 dark:border-white/5 relative overflow-hidden transition-colors">
        <form className="flex flex-col gap-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col gap-3">
              <label htmlFor="nombre" className="text-xs font-bold uppercase tracking-[0.15em] text-neutral-600 dark:text-neutral-400 ml-1">Nombre</label>
            ...
            <div className="flex flex-col gap-3">
              <label htmlFor="email" className="text-xs font-bold uppercase tracking-[0.15em] text-neutral-600 dark:text-neutral-400 ml-1">Email</label>
          ...
          <div className="flex flex-col gap-3">
            <label htmlFor="mensaje" className="text-xs font-bold uppercase tracking-[0.15em] text-neutral-600 dark:text-neutral-400 ml-1">Mensaje</label>
          ...
          <div className="flex justify-center mt-4">
            <button type="button" className="text-xs font-bold uppercase tracking-widest text-white border border-azul-logo bg-azul-logo px-10 py-4 hover:bg-transparent hover:text-azul-logo dark:hover:text-white transition-all duration-300 w-full md:w-auto cursor-pointer shadow-sm">
              Enviar Mensaje
            </button>
          </div>
        </form>
